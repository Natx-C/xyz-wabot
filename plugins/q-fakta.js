let handler = async(m) => {
let fakta = pickRandom(global.faktaa)
    const buttons = [
  {buttonId: '.fakta ', buttonText: {displayText: 'Fakta!!!'}, type: 1}
]

const buttonMessage = {
location: { jpegThumbnail: await(await require('node-fetch')(fla + 'Fakta')).buffer()},
    caption: fakta,
    footer: wm,
    buttons: buttons,
    headerType: 6
